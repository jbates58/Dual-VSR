...
void setup(void) 
{
  Serial.begin(9600);
    ...
    Serial.println("    Dual Battery    ");
    Serial.println("   VSR Controller   ");
    Serial.println("Firmware Version 1.1");

        // set the LCD cursor position:
    lcd.setCursor(1, 1);
        // print the Below Text
    lcd.print("    Dual Battery    ");
        // set the LCD cursor position.
    lcd.setCursor (1, 2);
        // print the  Below Text
    lcd.print("   VSR Controller    Firmware Version 1.1");
  ...
  sensors.setResolution(Ambient_Temp, 9);
  Serial.print("Device 0 Resolution: ");
  Serial.print(sensors.getResolution(Ambient_Temp), DEC); 
  Serial.println();
...
void Ambient_Temp (void)
{
        //Read Ambient Air Temp Using BS18B20 Temp Sensor.
    sensors.requestTemperatures();
    printTemperature(Ambient_Temp);
